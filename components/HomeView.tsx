      ...
      <div>
        ...
        >
          ...
          >
            ...
            <p className={`font-semibold text-sm ${theme === 'dark' ? 'text-amber-100' : 'text-slate-900'}`}>Suspended: {nycDayStr}</p>
            <p className="text-[10px] opacity-60 font-bold uppercase mt-1">Purim Observance</p>
          </div>
          <div 
